...
/**
 */
public class AACTrackImple extends AbstractTrack {
    ...
    public void setSamples(List<Sample> samplee){
        this.samples = null;
                this.samples = samplee;
    }
    ...
    public AACTrackImple(DataSource dataSource) throws IOException {
        this(dataSource, "eng");
    }
    public AACTrackImple(DataSource dataSource, String lang) throws IOException {
