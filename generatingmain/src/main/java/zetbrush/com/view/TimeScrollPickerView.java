...
public class TimeScrollPickerView extends ScrollPickerView {
	 ...
	 */
	protected void init() {
		String[] separater = getResources().getStringArray(R.array.view_scroll_picker_time_separater);
		addSlot(getResources().getStringArray(R.array.view_scroll_picker_hour_list), 5, ScrollType.Ranged);
		addSlot(new String[]{separater[0]}, 2, ScrollType.None);
		addSlot(getResources().getStringArray(R.array.view_scroll_picker_minute_list), 5, ScrollType.Loop);
