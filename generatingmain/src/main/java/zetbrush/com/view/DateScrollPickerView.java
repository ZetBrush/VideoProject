...
public class DateScrollPickerView extends ScrollPickerView {
	...
	protected void init() {
		String[] separater = getResources().getStringArray(R.array.view_scroll_picker_ymd_separater);
		addSlot(getResources().getStringArray(R.array.view_scroll_picker_year_list), 5, ScrollType.Ranged);
		addSlot(new String[]{separater[0]}, 2, ScrollType.None);
		addSlot(getResources().getStringArray(R.array.view_scroll_picker_month_list), 5, ScrollType.Ranged);
		addSlot(new String[]{separater[1]}, 2, ScrollType.None);
		addSlot(getResources().getStringArray(R.array.scroll_picker_day_list), 5, ScrollType.Loop);
